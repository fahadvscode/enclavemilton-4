...
const residenceDescription =
  "The Enclave (also known as The Enclave Milton, The Enclave Milton Townhomes, and The Enclave Milton Sundial Homes) is a master-planned freehold townhome community by Sundial Homes on Britannia Road in Milton, Ontario, Canada — not to be confused with similarly named projects in the United States. The development delivers two distinct product lines for Halton Region buyers: the Village Collection of back-to-back freehold townhomes, and the Park Collection of traditional two- and three-storey townhomes scaled for growing families. Occupancy is communicated for 2027. The location sits between James Snow Parkway and Fourth Line with planned trails, a village square, and a future elementary school in the master plan. Buyers access Highway 401, Highway 407, and Milton GO for commuting across the GTA.";
